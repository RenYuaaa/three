        ...
        <menu>
            <div class="container clearfix">
                <ul class="clearfix f_left">
                    ...
                    <li><a href="#">关于我们</a></li>
                    <li class="menu_active"><a href="${pageContext.request.contextPath}/showMyProfile.action">个人中心</a></li>
                </ul>
                <div id="search_group">
                ...
                <div id="user_bar">
                    ...
                    <a href="${pageContext.request.contextPath}/user/loginOut.action" id="lay_out">退出</a>
                </div>
            </div>
        </menu>
    </header>
