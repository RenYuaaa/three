...
<head>
    ...
    $(function(){
        ...
        $.post("${pageContext.request.contextPath}/updatePlayNum.action",params);
     });
    </script>
</head>
                ...
                <div class="container">
                    <div class="v-intro">
                        ...
                        <div class="right">
                            ...
                            <div class="avatar">
                                <span style="background-image: url(${speaker.head_img_url})"></span>
                ...
                <div class="container">
                    ...
                    <c:forEach items="${videoList}" var="video" >
	                    <div class="chapter"  onclick="load(${video.id})">
	                        <p class="biaoti"><a href="showVideo.action?videoId=${video.id}&subjectName=${video.subjectName}">${video.title}</a></p>
